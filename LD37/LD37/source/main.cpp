...
public:
	...
	*/
	void Init() override
	{
		m_vfs.Mount("bin/Release/assets/scripts");
		m_vfs.Mount("bin/Release/assets/maps");
		m_vfs.Mount("bin/Release/assets/music");
		m_vfs.Mount("bin/Release/assets/textures");
		m_vfs.Mount("bin/Release/assets/fonts");
		...
		// add fonts
		m_fontManager.Add("mono", "vcrosdmono.ttf");
